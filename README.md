...
To download and run Gremlin Console, `make download-gremlin-console`. Here's what it looks like on a working system:

```
jrr@jrrmbp ~/r/gremlin-console-jvms (main)> make download-gremlin-console 
...
--2022-03-30 09:31:35--  https://ftp.wayne.edu/apache/tinkerpop/3.5.2/apache-tinkerpop-gremlin-console-3.5.2-bin.zip
...
.gremlin-console/apache-tinkerpop-gr 100%[====================================================================>]  93.39M  39.3MB/s    in 2.4s    

2022-03-30 09:31:37 (39.3 MB/s) - ‘.gremlin-console/apache-tinkerpop-gremlin-console-3.5.2-bin.zip’ saved [97930338/97930338]
...
.gremlin-console/apache-tinkerpop-gremlin-console/bin/gremlin.sh --version
gremlin 3.5.2
jrr@jrrmbp ~/r/gremlin-console-jvms (main)> 
```
